...
function cmp_render_foh_portal() {
                    ...
                    <table class="sub-table">
                        ...
                        <tbody>
                            <?php if(empty($tabs[$tab_key])): ?>
                                <tr class="empty-row"><td colspan="7" style="text-align:center; padding:30px; color:#666;">No subscriptions found.</td></tr>
    ...
    function renderTable() {
        ...
        if (!noResultsRow) {
            ...
            noResultsRow.innerHTML = '<td colspan="7" style="text-align:center; padding:30px; color:#666;">No customers match your search criteria.</td>';
